...
import { getOutdatedProducts } from '../../src/services/crawlers'
...
describe('getOutdatedProducts', () => {
  describe('when undefined', () => {
    test('returns false', async () => {
      ...
      // Updated 2 hours ago and returns only 2 records
      const outdatedProducts = await getOutdatedProducts(2, 2)
