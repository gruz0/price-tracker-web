...
const Screen = () => {
  ...
  const SegmentContent = ({ children }) => (
    <Segment basic style={{ padding: isSmallScreen ? '2em 0em' : '3em 0em' }}>
      <Container text={!isSmallScreen}>{children}</Container>
    </Segment>
  )
  ...
  return (
    <>
      ...
      <Segment raised secondary padded={isSmallScreen ? 'tiny' : 'very'}>
        <Container text={isSmallScreen}>
          <MyH3>Кому этот сервис точно не подойдёт?</MyH3>

          <p style={{ fontSize: '1.33em' }}>
            Мы провели небольшой опрос и выяснили, кому
            <strong> Chartik </strong>
            точно не понравится — тем, кто не пользуется Избранным в
            маркетплейсах или предпочитает покупать спонтанно, вместо того,
            чтобы отслеживать цены на любимые товары.
          </p>
        </Container>
      </Segment>

      <SegmentContent>
        <MyH3>А теперь прелюдия...</MyH3>

        <p style={{ fontSize: '1.33em' }}>
          Никто не хочет переплачивать за товары, цены на которые скачут
          периодически. Бывает очень неприятно, когда ты купил какую-то дорогую
          книгу или подарок любимому человеку, а завтра тебе приходит
        ...
        <p style={{ fontSize: '1.33em' }}>
          У нас (Саша и Лиза) больше 500 товаров в хотелках и избранном в разных
          интернет-магазинах и на данный момент нет технической возможности
          следить за актуальностью цен и наличием позиций.
        </p>
      ...
      <SegmentContent>
        <p style={{ fontSize: '1.33em' }}>
          ...
          Xbox Elite Wireless Controller, потому что хочу эту штуку очень давно
          и собирался купить при понижении цены, но не успел…
        </p>
      ...
      <SegmentContent>
        <p style={{ fontSize: '1.33em' }}>
          Поэтому мы решили сделать этот сервис по отслеживанию цен и состоянию
          наличия товаров в интернет-магазинах – <strong>Chartik!</strong>
        </p>
        ...
        <p style={{ fontSize: '1.33em' }}>
          ...
          которые сейчас не очень интересны. Я бы хотел видеть изменения только
          по тем товарам, которые мне действительно нужны.
        </p>
        ...
        <p style={{ fontSize: '1.33em' }}>
          На этапе бета-тестирования мы сделали поддержку трёх популярных
          магазинов: OZON, WILDBERRIES и Lamoda.
        </p>

        <p style={{ fontSize: '1.33em' }}>
          Остальные магазины будут добавляться по мере запросов от пользователей
          и технических возможностей с нашей стороны.
        </p>
        ...
        <p style={{ fontSize: '1.33em' }}>
          Мы очень благодарны всем пользователям, кто поверил в нас на начальном
          этапе и зарегистрировался до даты публичного запуска.
        </p>
      ...
      <SegmentContent>
        ...
        <p style={{ fontSize: '1.33em' }}>
          ...
          из ваших списков, чтобы вам не приходилось вручную добавлять десятки и
          сотни товаров.
        </p>
        ...
        <p style={{ fontSize: '1.33em' }}>
          ...
          нужного вам товара сейчас нет в наличии, но вы хотите узнать от бота,
          когда этот товар появится в магазине и по какой цене.
        </p>
      </SegmentContent>
      ...
      <SegmentContent>
        <p style={{ fontSize: '1.33em' }}>
          Как только товар появится в магазине, наш бот пришлёт вам сообщение со
          ссылкой на магазин и вы прямо из Телеграма сможете перейти в магазин и
          купить нужную вам позицию.
        </p>
      ...
      <SegmentContent>
        ...
        <List>
          ...
          <List.Item>
            <List.Icon name="star" />
            <List.Content>
              А ещё оставлять примечания, чтобы не забыть, кто посоветовал этот
              товар
            </List.Content>
          </List.Item>
        </List>
